...
95
96
97</td><td class="line-coverage"><span class="cline-any cline-yes">3</span>
...
&nbsp;
        gutil.log(
            (opts.name ? <span class="branch-0 cbranch-no" title="branch not covered" >gutil.colors.cyan(opts.name) + ' is watching':</span> 'Watching'),
            gutil.colors.cyan(count),
            (count === 1 ? <span class="branch-0 cbranch-no" title="branch not covered" >'file...' </span>: 'files...'));
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (opts.name) { <span class="cstat-no" title="statement not covered" >msg.unshift(gutil.colors.cyan(opts.name) + ' saw'); </span>}
...
&nbsp;
        var glob = [filepath];
&nbsp;
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (opts.emit === 'all') { <span class="cstat-no" title="statement not covered" >glob = getWatchedFiles(duplex.gaze); </span>}
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Jan 08 2014 09:12:06 GMT+0600 (YEKT)</div>
</div>
